  ...
  <ul class="guild-nav-wrapper">
    <li class="guild-item-wrapper">
      ...
      <div class="guild-container">
        <nuxt-link to="/file">
          <div class="guild-image guild-home" >
    ...
    <li class="guild-item-wrapper" v-for="guild in guilds" :key="guild.id">
      <div class="guild-select-wrapper">
        <span class="guild-select-indicator"></span>
      </div>
      <div class="guild-container">
        <nuxt-link :to="`/file/${guild.id}`" class="">
